...
function messagingToKeyboard() {
	...
	if (messaging.style.display == 'block') {
...
function start() {
	...
	GazeCloudAPI.OnResult = function (GazeData) {
		...
		var maintomessage = document.getElementById('messagingbut');
		...
		var object_13 = typemessage.getBoundingClientRect();
		var object_14 = sendmessage.getBoundingClientRect();
		var object_15 = clearmessage.getBoundingClientRect();
		var object_16 = maintomessage.getBoundingClientRect();
		...
		//keyboard to main back button
			...
			object_1.left < object_12.left + object_12.width &&
			object_1.left + object_1.width > object_12.left &&
			object_1.top < object_12.top + object_12.height &&
			object_1.top + object_1.height > object_12.top
		) {
			setTimeout(function () {
				startCount();
			}, 4000);
		...
		//Type Message. message to keyboard
		else if (
			object_1.left < object_13.left + object_13.width &&
			object_1.left + object_1.width > object_13.left &&
			object_1.top < object_13.top + object_13.height &&
			object_1.top + object_1.height > object_13.top
		) {
			setTimeout(function () {
				startCount();
			}, 4000);
			if (c == 4) {
				document.getElementById('typemessage').click();
				stopCount();
				c = 0;
			}
		}
		...
		//send message
			...
			object_1.left < object_14.left + object_14.width &&
			object_1.left + object_1.width > object_14.left &&
			object_1.top < object_14.top + object_14.height &&
			object_1.top + object_1.height > object_14.top
		) {
			setTimeout(function () {
				startCount();
			}, 4000);
		...
		//clear text on message type box
		else if (
			object_1.left < object_15.left + object_15.width &&
			object_1.left + object_1.width > object_15.left &&
			object_1.top < object_15.top + object_15.height &&
			object_1.top + object_1.height > object_15.top
		) {
			setTimeout(function () {
				startCount();
			}, 4000);
			if (c == 4) {
				document.getElementById('clearmessage').click();
				stopCount();
				c = 0;
			}
		}
		...
		//main to messaging
			...
			object_1.left < object_16.left + object_16.width &&
			object_1.left + object_1.width > object_16.left &&
			object_1.top < object_16.top + object_16.height &&
			object_1.top + object_1.height > object_16.top
		) {
			setTimeout(function () {
				startCount();
			}, 4000);
			if (c == 4) {
				document.getElementById('messagingbut').click();
				stopCount();
				c = 0;
			}
		} else {
